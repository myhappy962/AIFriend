...
import FriendIcon from "@/components/navbar/icons/FrinedIcon.vue";
import CreateIcon from "@/components/navbar/icons/CreatIcon.vue";
import SearchIcon from "@/components/navbar/icons/SearchIcon.vue";
import {useUserrStore} from "@/stores/user.js";
